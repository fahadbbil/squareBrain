...
jQuery(document).ready(function () {
    ...
    jQuery('.custom-media-url').on('change', function () {
        var image_url = jQuery(this).closest('.customizer-repeater-general-control-repeater-container').find('.custom-media-url').val();
        jQuery('.sq_img_cus').attr('src',image_url); 
        customizer_repeater_refresh_general_control_values();
        return false;
    });
